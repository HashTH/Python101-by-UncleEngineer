...
B1 = Button(F2,text='หน้าหลัก',width=17,height=1,font=('TH Sarabun New',20),fg='black',bg='#F0D579',command='')
B1.grid(row=0,column=0,ipady=10,ipadx=0)
B2 = Button(F2,text='บันทึกรายการ',font=('TH Sarabun New',20),fg='black',bg='#F0D579',command=open_add)
B2.grid(row=0,column=1,ipady=10,ipadx=30)
B2 = Button(F2,text='รายงาน',font=('TH Sarabun New',20),fg='black',bg='#F0D579',command='')
